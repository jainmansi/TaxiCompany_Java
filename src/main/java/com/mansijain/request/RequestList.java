...
public class RequestList {
	...
	private static ArrayList<Request> vanRequests = new ArrayList<Request>();
	private static ArrayList<Request> carRequests = new ArrayList<Request>();
	private static ArrayList<Request> motorcycleRequests = new ArrayList<Request>();
	private static ArrayList<Request> vanWaitlist = new ArrayList<Request>();
	private static ArrayList<Request> carWaitlist = new ArrayList<Request>();
	private static ArrayList<Request> motorcycleWaitlist = new ArrayList<Request>();
